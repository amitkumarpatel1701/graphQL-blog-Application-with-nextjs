...
const PostCard = ({ post }) => (
  <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8">
    ...
    <h1 className="transition duration-700 text-center mb-8 cursor-pointer hover:text-pink-600 dark:hover:text-pink-400 text-3xl font-semibold">
    ...
    <div className="block lg:flex text-center items-center justify-center mb-8 w-full">
      <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8 items-center">
        ...
        />
        <p className="inline align-middle text-gray-700 dark:text-gray-300 ml-2 font-medium text-lg">{post.author.name}</p>
      </div>
    ...
    <p className="text-center text-lg text-gray-700 dark:text-gray-300 font-normal px-4 lg:px-20 mb-8">
      {post.excerpt}
    </p>
